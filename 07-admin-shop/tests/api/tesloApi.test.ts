...
describe('teslo axios instance', () => {
  ...
  test('should set Authorization hearer with token from localhost', async () => {
  ...
  test('should not set Authorization hearer if token is not in LocalStorage', async () => {
    localStorage.clear();
