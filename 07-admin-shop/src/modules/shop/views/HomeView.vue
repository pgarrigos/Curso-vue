<template>
  <div>
    ...
    <!-- Tab Menu -->
    <div
      class="flex flex-wrap items-center justify-center py-10 overflow-x-auto overflow-y-hidden text-gray-800 bg-white"
    >
      <a
        ...
        >
          <a href="#">
            <div class="relative flex items-end overflow-hidden rounded-xl">
              ...
              />
              <div
                class="absolute inline-flex items-center p-2 bg-white rounded-lg shadow-md bottom-3 left-3"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
